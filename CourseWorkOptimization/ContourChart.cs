...
namespace OxyPlot.Series
{
    ...
    public class ContourSeries : XYAxisSeries
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref = "OxyPlot.Series.ContourSeries" /> class.
        /// </summary>
        ...
        public void CalculateContours()
        {
            ...
            if (actualContourLevels == null)
            {
                ...
                for (int i = 0; i < this.Data.GetUpperBound(0); i++)
                {
                    ...
                    {
                        if (this.Data[i, j] is not Double.NaN)
                        {
        ...
        {
            /// <summary>
            /// Initializes a new instance of the <see cref="OxyPlot.Series.ContourSeries.SegmentPoint" /> class.
            /// </summary>
            ...
            /// <summary>
            /// Gets or sets a value indicating whether this <see cref="OxyPlot.Series.ContourSeries.SegmentPoint"/> already was added to a <see cref="OxyPlot.Series.ContourSeries.Contour"/>.
            /// </summary>
        ...
        private class Contour
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="OxyPlot.Series.ContourSeries.Contour" /> class.
            /// </summary>
        ...
        private class ContourSegment
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="OxyPlot.Series.ContourSeries.ContourSegment" /> class.
            /// </summary>
